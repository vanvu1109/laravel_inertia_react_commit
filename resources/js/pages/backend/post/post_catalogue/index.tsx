...
import type { PostCatalogue } from './save';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: '/backend/post_catalogue',
    },
];

const pageConfig: PageConfig<PostCatalogue> = {
    heading: 'Quản Lý Nhóm bài viết',
    module: '/backend/post_catalogue',
    cardHeading: 'Bảng Quản Lý Danh Sách ',
    cardDescription: 'Quản lý thông tin danh sách các Nhóm bài viết, sử dụng các chức năng để lọc dữ liệu... ',
    filters: [...filter],
    columns : [
...
export default function PostCatalogueIndex({users, records}: IPostCatalogueIndexProps) {
    ...
    const {
        ...
        selectedIds,
        setSelectedIds
    } = useTable<PostCatalogue>({pageConfig, rerords: records.data})
